...
/**
 * Interface used as part of a {@link com.buggysofts.clvl.GPSLPRules} to allow application authors to obfuscate
...
public interface Randomizer {
     ...
     * @throws GPSLValidationExceptionrrors Optionally thrown if a data integrity check fails.
     */
    String unobfuscate(String obfuscated, String key) throws GPSLValidationExceptionrrors;
}
