...
public class PreferenceObfuscator {
     ...
     */
    public PreferenceObfuscator(SharedPreferences sp, Randomizer o) {
        mPreferences = sp;
        mRandomizer = o;
        mEditor = null;
    }
    ...
    public void putString(String key, String value) {
        ...
        String obfuscatedValue = mRandomizer.obfuscate(value, key);
    ...
    public String getString(String key, String defValue) {
        ...
        if (value != null) {
            try {
                result = mRandomizer.unobfuscate(value, key);
            } catch (GPSLValidationExceptionrrors e) {
