 ...
 */
public class ServerProcessedAgreementRules implements com.buggysofts.clvl.GPSLPRules {

    private static final String TAG = "ServerManagedPolicy";
    private static final String PREFS_FILE = "com.buggysofts.clvl.ServerManagedPolicy";
     ...
     */
    public ServerProcessedAgreementRules(Context context, com.buggysofts.clvl.Randomizer randomizer) {
        // Import old values
    ...
    public boolean allowAccess() {
        ...
        if (mLastResponse == com.buggysofts.clvl.GPSLPRules.GPSLAllowed) {
            // Check if the GPSLAllowed response occurred within the validity timeout.
