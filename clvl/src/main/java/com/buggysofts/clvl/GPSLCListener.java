 ...
 * <p>
 * Upon checking with the Market server and conferring with the {@link com.buggysofts.clvl.GPSLPRules},
...
public interface GPSLCListener {
     ...
     */
    void GPSLDValidated(int reason);

    /** Application error codes. */
    int ERROR_INVALID_PACKAGE_NAME = 1;
    int ERROR_NON_MATCHING_UID = 22;
    int ERROR_NOT_MARKET_MANAGED = 333;
    int ERROR_CHECK_IN_PROGRESS = 4444;
    int ERROR_INVALID_PUBLIC_KEY = 55555;
    int ERROR_MISSING_PERMISSION = 666666;
